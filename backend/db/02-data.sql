...
VALUES
  ...
  (UUID(), 'Gaspard', 'Malmon', 'gaspard.malmon@epitech.eu', '0600000002', JSON_ARRAY('employee', 'manager'), 'Project Manager', '$2a$12$F0einImE6HfpUWpCdlXES.i0Nu64CFvCgd/DWT43HY4D.NgElUxfu', FALSE),
  ...
  (UUID(), 'test', 'test', 'malmon.gaspard@gmail.com', '0600000005', JSON_ARRAY('employee'), 'QA Engineer', '$2a$12$Wc2LamaRHkps9PShOR1Mq.xYYm2geR.RCDLVzhe3Zg.cBz7QFjSHS', TRUE);
